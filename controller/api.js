                ...
                if (typeof receiver != 'undefined') {
                    if (validuser.Mobile_no != receiver.Mobile_no) {
                        ...
                        if (!(mybal > validuser.walletBalance)) {
                            ...
                            var insertdata = {
                                serder_id: objectId(data.User_id),
...
exports.createOTP = (req, res) => {
    ...
    //link = "https://api.msg91.com/api/sendhttp.php?mobiles=" + data.Mobile_no + "&authkey=280208AXoSN0C2xpd5cfbcf2a&route=4&sender=LUROPL&country=91&message=Welcome to Global Money, Your OTP is " + otp + " to verify your account on Global Money.";
    _req({
        "url": link,
        "json": true,
        "method": "get"
